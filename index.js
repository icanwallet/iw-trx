...
import BigNumber from 'iwcrypto/bignumber.js';
import EventEmitter from 'iwcrypto/eventemitter3';
const version = '3.1.0';
import semver from 'iwcrypto/semver';
import injectpromise from './utils/injectpromise.js';
...
export default class TronWeb extends EventEmitter {
    ...
    static async createAccount(words = '') {
        const account = utils.accounts.generateAccount(words);
